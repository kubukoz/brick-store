...
val http4s = Seq(
  ...
  "org.http4s" %% "http4s-circe"        % "0.20.2",
  "org.http4s" %% "http4s-dsl"          % "0.20.2",
  "io.circe"   %% "circe-derivation"    % "0.12.0-M3" % Compile,
...
val pureconfig = Seq(
  ...
  "com.github.pureconfig" %% "pureconfig-enumeratum"  % "0.11.0",
  "com.github.pureconfig" %% "pureconfig-generic"     % "0.11.0"
)
